...
**AI/ML Engineer | SaaS Product Builder | Technical Entrepreneur**

Building intelligent systems that solve real business problems. Based in India, working on AI-powered products that drive measurable impact.

---

## 💡 What I Do

- **AI/ML Solutions**: Knowledge systems, RAG implementations, LLM integrations
...
### 🏆 Flagship Applications (Production Deployed)
...
- Supabase (PostgreSQL, Real-time DB)
...
- **Most Active Months**: April, May, November (intensive project sprints)
